...
abstractions.}  We first define Datalog (\refsec{datalog}), which describes the
...
$k$-limited analyses (see \refsec{abstractions}).
...
Each abstract tuple is derived by a rule whose source terms corresponding to the incoming edges.
