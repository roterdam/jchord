...
% Basics
We now introduce our $k$-object-sensitive pointer analysis \cite{kobj},
...
% Relate 
We now describe the $k$-object-sensitive pointer analysis (\reffig{aliasAnalysisRules}) in terms of our general notation presented in \refsec{preliminaries}.
