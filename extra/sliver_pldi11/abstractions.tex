...
The basic abstraction (\refsec{klimitedAbstraction}) corresponds exactly to
...
However, we can compose $\hclass$ and $\klimabs_k$ to yield another abstraction which will be coarser than $\klimabs_k$.
