...
public class RegisterAccessPath extends AccessPath {
    ...
    public boolean equals(Object obj) {
		...
		if (!(obj instanceof RegisterAccessPath)) return false;
		RegisterAccessPath that = (RegisterAccessPath)obj;
		return this.var.equals(that.var) && this.fields.containsAll(that.fields) && that.fields.containsAll(this.fields);
    }
}
