...
{\bf Desc.:} Generated before thread t executes a \code{new} bytecode instruction at program point h and allocates new object o. \\
...
\item
Method call \\
{\bf Event:} \code{BEF_METHOD_CALL} i t o \\
...
{\bf Event:} \code{AFT_METHOD_CALL} i t o \\
...
{\bf Note:} These events are not generated before/after constructor calls; use \code{BEF_NEW} and \code{AFT_NEW} events for that purpose.
