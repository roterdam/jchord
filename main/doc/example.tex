...
where \code{<PROGRAM DIR NAME>} specifies an example Java program as described above,
and each of \code{<name1>}, ..., \code{<nameN>} is the name of an analysis to run,
such as \code{<JAVA ANALYSIS NAME>} and \code{<DLOG ANALYSIS NAME>} in the Java and
...
For the above example, this directory is \code{<PROGRAM DIR NAME>/chord_output/}.
