...
Each domain of $N$ elements is assigned $log_2 N$ BDD variables in the underlying BDD factory with contiguous IDs.
For instance,
domain {\tt F0} of [2048..4096) elements will be assigned 12 variables with IDs (say) 59,60,61,62,63,64,65,66,67,68,69,70 and
