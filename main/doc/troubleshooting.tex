...
We assume that the following command was run in \Chord's \code{main/} directory:
...
\noindent where \code{<sys-props>} denotes a whitespace-separated list of zero of more property definitions
of the form \code{-D<key>=<value>} (see Section \ref{sec:chord-sysprops} for an exhaustive listing of all
