...
\item
\code{libchord_instr_agent.so}: this file is needed only if you want the JVMTI-based bytecode
...
then the C source code of BDD library \xlink{BuDDy}{http://buddy.sourceforge.net/} 
...
\code{libbuddy.dylib} on MacOS); this library is used 
by BDD-based Datalog solver \xlink{bddbddb}{http://bddbddb.sourceforge.net/} 
