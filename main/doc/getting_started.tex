...
\code{agent/}) and a C++ compiler (to build the above shared libraries).
...
Each ``\code{-D<key>=<val>}" argument above sets the system property
named \code{<key>} to the value denoted by \code{<val>}.  The only
