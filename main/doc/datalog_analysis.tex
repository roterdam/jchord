...
logic-programming language called Datalog.  This chapter describes everything about
...
See Section \ref{chap:bdd-representation} for more details on BDD representations.
