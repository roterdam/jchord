...
Run the datarace analysis provided in Chord by running the following command in Chord's \code{main/} directory:
...
\code{.class} files) and then run the above command in Chord's \code{main/} directory
with \code{<...>} replaced by \code{examples/datarace_test/}.
