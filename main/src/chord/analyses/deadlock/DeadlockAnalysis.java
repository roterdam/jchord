...
public class DeadlockAnalysis extends JavaAnalysis {
	...
	private void printResults() {
		...
		OutDirUtils.copyResource("chord/analyses/deadlock/web/results.dtd");
		OutDirUtils.copyResource("chord/analyses/deadlock/web/results.xml");
		OutDirUtils.copyResource("chord/analyses/deadlock/web/group.xsl");
		OutDirUtils.copyResource("chord/analyses/deadlock/web/paths.xsl");
