...
public class TestAnalyzers{
  ...
  public static void main(String[] args){
	...
	System.err.println("Exception in TestAnalyzers : ");
	e.printStackTrace();
     }
  }
  ...
  static void verifyPayload(TokenStream ts) throws IOException {
    Token t = new Token();
    for(byte b=1;;b++) {
      t.clear();
      t = ts.next(t);
  ...
  public static void testPayloadCopy() throws IOException {
