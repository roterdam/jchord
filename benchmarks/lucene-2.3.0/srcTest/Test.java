//taken from http://javatechniques.com/blog/lucene-in-memory-text-search-example/
/**
...
public class Test {
    ...
    public static void main(String[] args) {
	    ...
	    Term term1 = new Term("title","Ayn Rand");
	    //Term term2 = new Term("content","There");
