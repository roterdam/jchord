...
public class TestIndexWriterMerging
{
  ...
  private static boolean verifyIndex(Directory directory, int startAt) throws IOException
  {
    boolean fail = false;
  ...
  private static void fillIndex(Directory dir, int start, int numDocs) throws IOException
  {
