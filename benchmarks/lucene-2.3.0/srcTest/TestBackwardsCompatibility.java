...
public class TestBackwardsCompatibility
{
  ...
  */
  ...
  public static void main(String[] args){
	...
	System.err.println("Exception in TestBackwardsCompatibility");
	e.printStackTrace();
    }
  }	  
  ...
  public static void testCreateCFS() throws IOException {
    String dirName = "testindex.cfs";
    createIndex(dirName, true);
    rmDir(dirName);
  }

  public static void testCreateNoCFS() throws IOException {
    String dirName = "testindex.nocfs";
    createIndex(dirName, true);
    rmDir(dirName);
  }

  final static String[] oldNames = {"prelockless.cfs",
                             "prelockless.nocfs",
                             "presharedstores.cfs",
                             "presharedstores.nocfs"};

  public static void testSearchOldIndex() throws IOException {
  ...
  public static void testIndexOldIndexNoAdds() throws IOException {
    for(int i=0;i<oldNames.length;i++) {
      String dirName = "src/test/org/apache/lucene/index/index." + oldNames[i];
      unzip(dirName, oldNames[i]);
  ...
  public static void testIndexOldIndex() throws IOException {
    for(int i=0;i<oldNames.length;i++) {
      String dirName = "src/test/org/apache/lucene/index/index." + oldNames[i];
      unzip(dirName, oldNames[i]);
  ...
  public static void searchIndex(String dirName) throws IOException {
   ...
   * setNorm, and search */
  public static void changeIndexWithAdds(String dirName, boolean autoCommit) throws IOException {
  ...
  /* Open pre-lockless index, add docs, do a delete &
   * setNorm, and search */
  public static void changeIndexNoAdds(String dirName, boolean autoCommit) throws IOException {
  ...
  public static void createIndex(String dirName, boolean doCFS) throws IOException {
  ...
  public static void testExactFileNames() throws IOException {
  ...
  private static String asString(String[] l) {
    String s = "";
  ...
  private static void addDoc(IndexWriter writer, int id) throws IOException
  {
