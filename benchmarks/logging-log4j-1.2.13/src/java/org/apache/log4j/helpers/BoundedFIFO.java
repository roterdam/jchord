...
public class BoundedFIFO {
  ...
  LoggingEvent get() {
    ...
    //System.out.println("in get() in BoundedFIFO...numElements changed...instance of BoundedFIFO is "+this);
    numElements--;    
    return r;    
  }
  ...
  void put(LoggingEvent o) {
	...
	next = 0;
      ...
      //System.out.println("in put() in BoundedFIFO...numElements changed...instance of BoundedFIFO is "+this);
      numElements++;
    }
  }
